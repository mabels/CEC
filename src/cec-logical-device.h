...
public:
	CEC_LogicalDevice(RemoteDebug &debug);
	void Initialize();
...
protected:
	...
	virtual void OnCECFrame(SerialByte *buffer, int count);
	// virtual void OnTransmitComplete(bool);

	virtual void OnReady() {;}
	virtual void OnCECPacket(CECPacket &cecPacket) = 0;
